...
public class PerfilService {
    ...
    @Transactional(readOnly = true)
    public Optional<PerfilDTO> findByUser(String userLogin) {
        return perfilRepository.findPerfilByUserLogin(userLogin).map(perfilMapper::toDto);
    }

    @Transactional(readOnly = true)
    public PerfilDTO findByUserDTO(String userLogin) {
        return findByUser(userLogin).orElse(null);
    }
