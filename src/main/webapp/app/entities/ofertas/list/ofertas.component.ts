...
import { EntityArrayResponseType, OfertasService } from '../service/ofertas.service';
...
export class OfertasComponent implements OnInit {
  ...
  delete(ofertas: IOfertas): void {
    const modalRef = this.modalService.open(OfertasDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.ofertas = ofertas;
