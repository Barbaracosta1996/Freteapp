...
describe('Solicitacao routing resolve service', () => {
  ...
  let resultSolicitacao: ISolicitacao | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultSolicitacao).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ISolicitacao>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
