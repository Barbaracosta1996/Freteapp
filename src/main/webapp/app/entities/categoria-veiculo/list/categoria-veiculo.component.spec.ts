...
describe('CategoriaVeiculo Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'categoria-veiculo', component: CategoriaVeiculoComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.categoriaVeiculos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to categoriaVeiculoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCategoriaVeiculoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCategoriaVeiculoIdentifier).toHaveBeenCalledWith(entity);
