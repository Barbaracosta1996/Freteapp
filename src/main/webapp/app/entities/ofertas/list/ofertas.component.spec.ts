...
describe('Ofertas Management Component', () => {
  let comp: OfertasComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'ofertas', component: OfertasComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(OfertasComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to ofertasService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getOfertasIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getOfertasIdentifier).toHaveBeenCalledWith(entity);
