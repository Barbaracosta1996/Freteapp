...
import com.infocargas.freteapp.service.CategoriaVeiculoQueryService;
import com.infocargas.freteapp.service.CategoriaVeiculoService;
...
/**
 * REST controller for managing {@link com.infocargas.freteapp.domain.CategoriaVeiculo}.
 */
@RestController
@RequestMapping("/api")
public class CategoriaVeiculoResource {
    ...
    public ResponseEntity<CategoriaVeiculoDTO> createCategoriaVeiculo(@Valid @RequestBody CategoriaVeiculoDTO categoriaVeiculoDTO)
    ...
    public ResponseEntity<CategoriaVeiculoDTO> updateCategoriaVeiculo(
        ...
        CategoriaVeiculoDTO result = categoriaVeiculoService.update(categoriaVeiculoDTO);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, categoriaVeiculoDTO.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/categoria-veiculos/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<CategoriaVeiculoDTO> partialUpdateCategoriaVeiculo(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody CategoriaVeiculoDTO categoriaVeiculoDTO
    ) throws URISyntaxException {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, categoriaVeiculoDTO.getId().toString())
        );
    }
    ...
    public ResponseEntity<List<CategoriaVeiculoDTO>> getAllCategoriaVeiculos(
        CategoriaVeiculoCriteria criteria,
        @org.springdoc.api.annotations.ParameterObject Pageable pageable
    ) {
        log.debug("REST request to get CategoriaVeiculos by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countCategoriaVeiculos(CategoriaVeiculoCriteria criteria) {
        log.debug("REST request to count CategoriaVeiculos by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
