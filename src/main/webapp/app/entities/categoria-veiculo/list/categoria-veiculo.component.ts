...
import { EntityArrayResponseType, CategoriaVeiculoService } from '../service/categoria-veiculo.service';
...
export class CategoriaVeiculoComponent implements OnInit {
  ...
  trackId = (_index: number, item: ICategoriaVeiculo): number => this.categoriaVeiculoService.getCategoriaVeiculoIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.categoriaVeiculos = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ICategoriaVeiculo[] | null): ICategoriaVeiculo[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.categoriaVeiculoService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
