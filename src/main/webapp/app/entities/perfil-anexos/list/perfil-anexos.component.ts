...
import { EntityArrayResponseType, PerfilAnexosService } from '../service/perfil-anexos.service';
...
@Component({
  selector: 'jhi-perfil-anexos',
  templateUrl: './perfil-anexos.component.html',
})
export class PerfilAnexosComponent implements OnInit {
  ...
  trackId = (_index: number, item: IPerfilAnexos): number => this.perfilAnexosService.getPerfilAnexosIdentifier(item);
  ...
  delete(perfilAnexos: IPerfilAnexos): void {
    const modalRef = this.modalService.open(PerfilAnexosDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.perfilAnexos = perfilAnexos;
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.perfilAnexos = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IPerfilAnexos[] | null): IPerfilAnexos[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.perfilAnexosService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
