...
public class UserService {
     ...
     */
    public void updateUser(String firstName, String lastName, String email, String langKey, String telephoneNumber, String imageUrl) {
        SecurityUtils
            .getCurrentUserLogin()
    ...
    @Transactional(readOnly = true)
    public UserDTO getUserWithAuthoritiesToDto() {
