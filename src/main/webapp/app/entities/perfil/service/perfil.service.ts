...
export class PerfilService {
  ...
  createProfile(perfil: IPerfil): Observable<EntityResponseType> {
    return this.http.post<IPerfil>(`${this.resourceUrl}/createProfile`, perfil, { observe: 'response' });
  }
  ...
  findByCurrentUser(): Observable<EntityResponseType> {
    return this.http.get<IPerfil>(`${this.resourceUrl}/current`, { observe: 'response' });
  }
