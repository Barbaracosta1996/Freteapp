...
@Component({
  selector: 'jhi-rotas-indicadas',
  templateUrl: './rotas-indicadas.component.html',
  styleUrls: ['./rotas-indicadas.component.scss']
})
export class RotasIndicadasComponent implements OnInit {

  ofertas: IOfertas[] = [];
  selectedOfertas: IOfertas[] = [];
  loading = false;

  constructor(protected activatedRoute: ActivatedRoute, private ofertaService: OfertasService,
